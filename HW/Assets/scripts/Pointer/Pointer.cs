...
public class Pointer : MonoBehaviour
{
    ...
    private void Awake() {
        ...
        DontDestroyOnLoad(this.gameObject);                                 // Potential lag problem
    }
    ...
    private void onDestroy()
    {
        ...
        // Add Destroy playerEvent for trigger
    }
    ...
    // Add void for ProcessTriggerDown OR 
    private void ProcessTriggerDown()
    {
        ...
        InteractableTrigger interactableTrigger = m_CurrentObject.GetComponent<InteractableTrigger>();
        interactableTrigger.Pressed();
    }
}
